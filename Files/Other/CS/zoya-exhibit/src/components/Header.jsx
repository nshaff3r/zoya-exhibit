...
const Headline = ({ windowWidth }) => {
    ...
    return (
        <div className="w-10/12 md:w-1/2 mx-auto absolute"
            style={{
            left: '50%',
            top: windowWidth < 640 ? '13%' : '33%',
            transform: 'translateX(-50%)'
            }}>
                <h1 className="text-3xl sm:text-5xl text-center text-[white]
...
const Subhead = () => {
    return (
        <div className="w-10/12 md:w-1/2 mx-auto absolute" style={{
            left: '50%',
            bottom: '37%',
            transform: 'translateX(-50%)'
        }}>
            <h1 className="text-md sm:text-xl text-center text-[white]
              bg-[#B9A28B]/[0.95] rounded-lg">
                {subhead}
            </h1>
        </div>
    );
...
const Byline = ({ windowWidth }) => {
    return (
        <div className="px-5 mx-auto absolute text-[white]
        bg-[#B9A28B]/[0.7] rounded-lg w-[60dvw] md:w-auto" style={{
            left: '50%',
...
const Divider = () => {
    return (
        ...
        className="w-2/3 max-w-md h-1 bg-white rounded-full absolute
                left-1/2 -translate-x-1/2" style={{ bottom: '27%' }}>
        </div>
    );
};
